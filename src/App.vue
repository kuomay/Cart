...
<template>
    <div class="container w-max mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div v-for="product in products" :key="product.id" class=" border rounded">
  ...
  const products = ref([
    ...
    { id: 3, name: '奶茶', price: 100, image: 'https://cdn.pixabay.com/photo/2018/07/18/07/56/drink-3545791_1280.jpg' },
